...
# date: 05/15/2019
# author: Pablo Reyes
# 1) Getting feature_download.py from cartopy repository:
# wget https://raw.githubusercontent.com/SciTools/cartopy/master/tools/feature_download.py
# 2) Adding --do_scales option to specify what scale to download, e.g. 110m
# This will be used to get the physical and cultural 110m scale data
# to have it already in resen-core. It weighs a couple of MB.
...
def download_features(group_names, dry_run=True,do_scales=ALL_SCALES):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--do_scales', nargs='+',
                        choices=('110m', '50m', '10m'),
                        help='All possible feature scales')
    ...
    download_features(args.group_names, dry_run=args.dry_run, do_scales=args.do_scales)
